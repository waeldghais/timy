...
class _SearchState extends State<Search> {
  ...
  void filterSearchResults(String query) async{
    ...
    // print(query);
    // List<Shows> dummyList=[];
    // if(query.isNotEmpty){
    //   List<Shows> tempSearchList=Provider.of<ShowsModel>(context,listen: false).findByShowTitle(query);
    //   print(tempSearchList.length);
...
//     if (query.isNotEmpty) {
//       List<Shows> dummyListData = List<Shows>();
      ...
      body:isLoading?Center(child: CircularProgressIndicator()):Container(
        ...
        child: Column(
          children: <Widget>[
            Padding(
              padding:
                  EdgeInsets.only(top: devHeight*0.067, left: devWidth*0.0333, right: devWidth*0.0333, bottom: 3),
