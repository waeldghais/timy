            ...
            child: ListView.builder(
              ...
              itemCount: product.length,
                itemBuilder: (context,i){
                  final shows=Provider.of<ShowsModel>(context).findById(product[i].id);
                  final _channel=Provider.of<ChannelModel>(context).findById(shows.channelUid);
                return Padding(
                  ...
                  child: GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Stack(
                        children: <Widget>[
                          Image.network(product[i].showsCoverLink, fit: BoxFit.fill,height: 150,width: 110,),
                          Padding(
                            ...
                            child: Align(alignment: Alignment.bottomCenter,
                              child:Container(
                                ...
                                child: Image.network(_channel.logoLink, height:30,width: 40, fit: BoxFit.scaleDown),
                              ),
                            ),
                          )
                        ],
