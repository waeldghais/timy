...
class _HomeState extends State<Home> {
 ...
 var product1,product2,product3,product4,product5,product6,product7,product8;
  ...
  void initState() {
    ...
    await Provider.of<ShowsModel>(context,listen: false).getCurrentAndNextPlayingShows();
...
product8 = productData.getGenre("Reality");
   ...
   var currentPage1,currentPage2,currentPage3,currentPage4,currentPage5,currentPage6,currentPage7,currentPage8;
  @override
  Widget build(BuildContext context) {
    // final productData = Provider.of<ShowsModel>(context);
    // final product1 = productData.shows;
    // final product2 = productData.getGenre("Movies");
    // final product3 = productData.getGenre("Series");
    // final product4 = productData.getGenre("Docs");
    // final product5 = productData.getGenre("Sports");
    // final product6 = productData.getGenre("Politics");
    // final product7 = productData.getGenre("News");
    // final product8 = productData.getGenre("Reality");
    if(!isLoading){
    ...
    PageController controller2 = PageController(initialPage: product2.length - 1);
    controller2.addListener(() {
      setState(() {
        currentPage2 = controller2.page;
      });
    });
    PageController controller3 = PageController(initialPage: product3.length - 1);
    controller3.addListener(() {
      setState(() {
        currentPage3 = controller3.page;
      });
    });
    PageController controller4 = PageController(initialPage: product4.length - 1);
    controller4.addListener(() {
      setState(() {
        currentPage4 = controller4.page;
      });
    });
    PageController controller5 = PageController(initialPage: product5.length - 1);
    ...
    PageController controller7 = PageController(initialPage: product7.length - 1);
    controller7.addListener(() {
      setState(() {
        currentPage7 = controller7.page;
      });
    });
    PageController controller8 = PageController(initialPage: product8.length - 1);
          ...
          child: Container(
            ...
            child: Stack(
              children: <Widget>[
                ...
                Padding(
                  padding:
                      EdgeInsets.only(top: 155, right: 0, left: 0, bottom: 0),
                  child: Container(
                    width: double.infinity,
                    height: double.infinity,
                    child: ListView(
                      children: <Widget>[
                        ...
                        ListOfShows(name:"Popular in my area",product: product1,),
                        ListOfShows(name:"movie",product: product2,),
                        ListOfShows(name:"series",product: product3,),
                        ListOfShows(name:"documentary",product: product4,),
                        ListOfShows(name:"sport",product: product5,),
                        ListOfShows(name:"talkShow",product: product6,),
                        ListOfShows(name:"news",product: product7,),
                        ListOfShows(name:"Reality Shows",product: product8,),
                      ],
                    ),
                  ),
                ),
